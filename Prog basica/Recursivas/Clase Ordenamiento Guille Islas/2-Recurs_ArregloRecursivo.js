...
function imprimirArregloRecAlReves(arreglo, indice, fin) {
    console.log("indice", indice);
    if (indice >= fin) {
        console.log("posicion ", indice, " tiene:", imprimirArregloRecAlReves(arreglo,indice-1, fin));
    };
    console.log("indice", indice);
    return arreglo[indice+1];
}
...
console.log("-----------------------------");
console.log("Como se imprime un arreglo recursivamente Al reves");
imprimirArregloRecAlReves(arreglo, n-1, 0);